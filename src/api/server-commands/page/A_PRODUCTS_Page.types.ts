...
export type A_PRODUCTS_SERVER_COMMANDS_TYPES__PageGetResponse = A_SDK_TYPES__Required<
...
export type A_PRODUCTS_SERVER_COMMANDS_TYPES__PageCreateResponse = A_SDK_TYPES__Required<
    A_SDK_TYPES__DeepPartial<A_PRODUCTS_TYPES__Page_APIEntity>, [
        'id',
        'aseid',
        'created_at',
...
export type A_PRODUCTS_SERVER_COMMANDS_TYPES__PageUpdateRequest = A_SDK_TYPES__Required<
    A_SDK_TYPES__DeepPartial<A_PRODUCTS_TYPES__Page_APIEntity>, [
        'aseid'
    ]>
...
// =========================  PAGE MIGRATE REQUEST API TYPES ================================
