...
export type A_PRODUCTS_SERVER_COMMANDS_TYPES__AppProfileGetRequest = {
    /**
...
export type A_PRODUCTS_SERVER_COMMANDS_TYPES__AppProfileUpdateRequest = {
    /**
     * App identifier in ADAAS System
     */
    aseid: string,
...
export type A_PRODUCTS_SERVER_COMMANDS_TYPES__AppProfileUpdateResponse = Partial<A_PRODUCTS_TYPES__AppProfile_APIEntity>




// =========================  APP PROFILE LOGO UPLOAD REQUEST API TYPES ================================
export type A_PRODUCTS_SERVER_COMMANDS_TYPES__AppProfileLogoUploadRequest = {
    /**
     * App identifier in ADAAS System
     */
    aseid: string,
...
export type A_PRODUCTS_SERVER_COMMANDS_TYPES__AppProfileLogoUploadResponse = {
