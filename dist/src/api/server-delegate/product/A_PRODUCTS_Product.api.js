...
exports.A_PRODUCTS_SERVER_DELEGATE__ProductAPI = void 0;
const a_auth_1 = require("@adaas/a-auth");
/**
 * API Provider for Products
 */
class A_PRODUCTS_SERVER_DELEGATE__ProductAPI extends a_auth_1.A_AUTH_ServerDelegate_APIProvider {
    get baseURL() {
    ...
    list(request, config) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this
                .get('/products', Object.assign(Object.assign({}, request.pagination), request.filter), config);
        });
    }
    /**
...
exports.A_PRODUCTS_SERVER_DELEGATE__ProductAPI = A_PRODUCTS_SERVER_DELEGATE__ProductAPI;
