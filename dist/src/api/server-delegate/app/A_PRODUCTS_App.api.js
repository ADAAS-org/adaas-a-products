...
exports.A_PRODUCTS_SERVER_DELEGATE__AppAPI = void 0;
const a_auth_1 = require("@adaas/a-auth");
/**
 * API Provider for Apps
 */
class A_PRODUCTS_SERVER_DELEGATE__AppAPI extends a_auth_1.A_AUTH_ServerDelegate_APIProvider {
    get baseURL() {
    ...
    load(request, config) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this
                .get(`/apps/${request.orgASEID}`, {}, config);
        });
    }
    /**
...
exports.A_PRODUCTS_SERVER_DELEGATE__AppAPI = A_PRODUCTS_SERVER_DELEGATE__AppAPI;
