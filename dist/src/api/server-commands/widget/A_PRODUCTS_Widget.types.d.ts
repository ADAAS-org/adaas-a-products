...
export type A_PRODUCTS_SERVER_COMMANDS_TYPES__WidgetGetResponse = A_SDK_TYPES__Required<A_SDK_TYPES__DeepPartial<A_PRODUCTS_TYPES__Widget_APIEntity>, [
    'id',
    'aseid',
    'overline',
    'headline',
...
export type A_PRODUCTS_SERVER_COMMANDS_TYPES__WidgetCreateResponse = A_SDK_TYPES__Required<A_SDK_TYPES__DeepPartial<A_PRODUCTS_TYPES__Widget_APIEntity>, [
    'aseid',
    'created_at',
    'updated_at'
]>;
export type A_PRODUCTS_SERVER_COMMANDS_TYPES__WidgetUpdateRequest = A_SDK_TYPES__Required<A_SDK_TYPES__DeepPartial<A_PRODUCTS_TYPES__Widget_APIEntity>, [
    'aseid'
]>;
