...
class A_PRODUCTS_SERVER_COMMANDS__AppSettingsAPI extends a_auth_1.A_AUTH_ServerCommands_APIProvider {
    ...
    load(request, config) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this
                .get(`/apps/${request.aseid}/settings`, {}, config);
        });
    }
    /**
    ...
    update(request, config) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this
                .put(`/apps/${request.aseid}/settings`, request.settings, config);
        });
    }
}
exports.A_PRODUCTS_SERVER_COMMANDS__AppSettingsAPI = A_PRODUCTS_SERVER_COMMANDS__AppSettingsAPI;
