...
export type A_PRODUCTS_APP_INTERACTIONS_TYPES__ProductGetResponse = A_SDK_TYPES__Required<A_SDK_TYPES__DeepPartial<A_PRODUCTS_TYPES__Product_APIEntity>, [
    'aseid',
    'Profile',
    'Settings',
    'created_at',
...
export type A_PRODUCTS_APP_INTERACTIONS_TYPES__ProductCreateResponse = A_SDK_TYPES__Required<A_SDK_TYPES__DeepPartial<A_PRODUCTS_TYPES__Product_APIEntity>, [
    'aseid',
    'created_at',
    'updated_at'
]>;
export type A_PRODUCTS_APP_INTERACTIONS_TYPES__ProductUpdateRequest = A_SDK_TYPES__Required<A_SDK_TYPES__DeepPartial<A_PRODUCTS_TYPES__Product_APIEntity>, [
    'aseid'
]>;
