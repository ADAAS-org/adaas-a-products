...
export type A_PRODUCTS_APP_INTERACTIONS_TYPES__AppGetResponse = A_SDK_TYPES__Required<A_SDK_TYPES__DeepPartial<A_PRODUCTS_TYPES__App_APIEntity>, [
    'aseid',
    'status',
    'Profile',
    'Settings',
...
export type A_PRODUCTS_APP_INTERACTIONS_TYPES__AppCreateResponse = A_SDK_TYPES__Required<A_SDK_TYPES__DeepPartial<A_PRODUCTS_TYPES__App_APIEntity>, [
    'aseid',
    'created_at',
    'updated_at'
]>;
export type A_PRODUCTS_APP_INTERACTIONS_TYPES__AppUpdateRequest = A_SDK_TYPES__Required<A_SDK_TYPES__DeepPartial<A_PRODUCTS_TYPES__App_APIEntity>, [
    'aseid'
]>;
